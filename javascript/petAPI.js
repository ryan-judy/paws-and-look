$(document).ready(function() {
    ...
    var AnimURL = "http://api.petfinder.com/pet.getRandom?format=json"
    var animLocLat;
    var animnLocLong;
    var zip = "";
    var catDogSelect = "";
  ...
  //         });
    ...
    $('#information').on('click', function() {
        ...
        $('html, body').animate({ scrollTop: 150 }, 'fast');
                ...
                $(".image").attr("href", "pet-choice-dogs.html");
                ...
                $(".main-login").append("<a href= 'pet-choice-dogs.html'><i class='fa fa-arrow-left'</i><p>Go Back</p></a>");
    })
...
// variables for user input and petfinder api output
    ...
    var queryURL = AnimURL + key + locationQuery;
    ...
    function handleLocationError(browserHasGeolocation, infoWindow, pos) {
      ...
      function AnimalAJAX(queryURL) {
            ...
            if (response.petfinder.pets == undefined) {
                ...
                queryURL = AnimURL + key + locationQuery;
                queryURL = queryURL.replace(" ", "+");
    ...
    function FireBaseFunction() {
    	 ...
    	 event.preventDefault();
    	  ...
    	  // console.log("FB " + animnLocLong);
            ...
            var pfApiUrl = "http://api.petfinder.com/pet.getRandom?format=json&key=f411ff9725d287d4138503a0c95030a6&output=basic"
